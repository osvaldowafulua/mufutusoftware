...
|------------|-------------------|--------|
| **Windows** | [`MUFUTU-Setup-1.0.23-x64.exe`](https://github.com/osvaldowafulua/mufutusoftware/releases/download/v1.0.23/MUFUTU-Setup-1.0.23-x64.exe) | Assistente completo (logo, EULA, escolha de pasta) — Program Files, atalhos, desinstalar em Definições. ZIP portátil: [1.0.23](https://github.com/osvaldowafulua/mufutusoftware/releases/download/v1.0.23/MUFUTU-1.0.23-win-x64.zip) |
| **macOS** | [`MUFUTU-1.0.23-arm64.dmg`](https://github.com/osvaldowafulua/mufutusoftware/releases/download/v1.0.23/MUFUTU-1.0.23-arm64.dmg) | Arrastar para Aplicações · duplo clique em **«Instalar MUFUTU — clique aqui»** dentro do DMG (sem Terminal) · Luachimo: API `sml.api.mufutu.ao` |
| **Android** | [`MUFUTU Campo 1.0.16`](https://github.com/osvaldowafulua/mufutusoftware/releases/download/mobile-maui%2Fv1.0.16/com.mufutu.mobile-Signed.apk) | APK assinado · técnicos / modo campo |
...
bash apps/desktop-mac/scripts/package.sh 1.0.23
```
